  ...
  const { form, Error, Value, setValue } = useForm({
    ...
    validate(v, form) {
      ...
      switch (props.type) {
        ...
        case 'password':
          if (!!props.matchFrom) {
            const other = form?.get?.(props.matchFrom);

            // if (v != form[props.matchFrom]) {
            //   console.log(v, form[props.matchFrom], 'form[props.matchFrom]');
            ...
            return [
              ...
              } needs: 1 uppercase, 1 lowercase, 1 special character, 1 number, and at least 8 characters total.`,
            ];
          }
          break;
        case 'text':
    ...
    <BaseInput
      ...
      {...(props?.type == 'password'
        ? {
            ...
            autoCapitalize: 'none',
            spellCheck: false,
            // ✅ stop weird direction / caret jump
            textAlign: 'left',
            writingDirection: 'ltr',
            // optional but helps some keyboards
